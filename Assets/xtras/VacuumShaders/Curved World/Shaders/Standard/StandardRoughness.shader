Shader "Hidden/VacuumShaders/Curved World/Standard/Roughness"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../cginc/UnityStandardCoreForward.cginc"
        ...
        Pass {
            ...
            #include "../cginc/UnityStandardShadow.cginc"
        ...
        Pass
        {
            ...
            #include "../cginc/UnityStandardCore.cginc"
